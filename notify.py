...
from HLDapi.websocket import HLDWebsocket
from HLD.instance import shared_HLD_instance
from HLD.market import Market
from HLD.price import Order, FilledOrder, UpdateCallOrder
from HLD.account import AccountUpdate
...
class Notify(Events):
    """ Notifications on Blockchain events.
        ...
        :param list markets: Instances of :class:`HLD.market.Market` that identify markets to be monitored
    ...
    def process_market(self, data):
        """ This method is used for post processing of market
            ...
            * :class:`HLD.price.Order` or
            * :class:`HLD.price.FilledOrder` or
            * :class:`HLD.price.UpdateCallOrder`
    ...
    def process_account(self, message):
        """ This is used for processing of account Updates. It will
            return instances of :class:HLD.account.AccountUpdate`
        """
