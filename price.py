...
class Price(dict):
    """ This class deals with all sorts of prices of any pair of assets to
        ...
        each being an instance of :class:`HLD.amount.Amount`. The
        ...
        Way to obtain a proper instance:
            ...
            * ``args`` can be a floating number and ``base`` and ``quote`` being instances of :class:`HLD.asset.Asset`
            ...
            * ``args`` being a list of ``[quote, base]`` both being instances of :class:`HLD.amount.Amount`
            * ``args`` being a list of ``[quote, base]`` both being instances of ``str`` (``amount symbol``)
            * ``base`` and ``quote`` being instances of :class:`HLD.asset.Amount`
    ...
    def market(self):
        """ Open the corresponding market
            ...
            :returns: Instance of :class:`HLD.market.Market` for the
...
class Order(Price):
    """ This class inherits :class:`HLD.price.Price` but has the ``base``
